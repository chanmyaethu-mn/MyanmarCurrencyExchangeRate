...
public class Rates {
    ...
    public String toString() {
        return "ClassPojo [CNY = " + CNY + ", JPY = " + JPY + ", CZK = " + CZK + ", BDT = " + BDT + ", LKR = " + LKR + ", KWD = " + KWD + ", VND = " + VND + ", CAD = " + CAD + ", NZD = " + NZD + ", AUD = " + AUD + ", ZAR = " + ZAR + ", KES = " + KES + ", GBP = " + GBP + ", NOK = " + NOK + ", ILS = " + ILS + ", CHF = " + CHF + ", RUB = " + RUB + ", PKR = " + PKR + ", SAR = " + SAR + ", EGP = " + EGP + ", INR = " + INR + ", THB = " + THB + ", IDR = " + IDR + ", SGD = " + SGD + ", HKD = " + HKD + ", KHR = " + KHR + ", DKK = " + DKK + ", SEK = " + SEK + ", RSD = " + RSD + ", MYR = " + MYR + ", BRL = " + BRL + ", EUR = " + EUR + ", NPR = " + NPR + ", PHP = " + PHP + ", USD = " + USD + ", LAK = " + LAK + ", KRW = " + KRW + ", BND = " + BND + "]";
    }
}
